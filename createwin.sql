...
CREATE TABLE [Images] ([Id] Bigint IDENTITY(1,1) PRIMARY KEY NOT NULL, [CacheId] bigint NULL, [GcCode] nvarchar (15) NULL, [Description] ntext, [Name] nvarchar (255) NULL, [ImageUrl] nvarchar (255) NULL, [IsCacheImage] bit NULL);
