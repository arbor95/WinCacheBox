...
namespace GeocachingAPI.Models
{
    ...
    public partial class UserWaypoint
    {
        /// <summary>
        /// Initializes a new instance of the UserWaypoint class.
        /// </summary>
        public UserWaypoint() { }
        ...
        /// Initializes a new instance of the UserWaypoint class.
        /// </summary>
        public UserWaypoint(bool isCorrectedCoordinates, Coordinates coordinates, string geocacheCode, string referenceCode = default(string), string description = default(string))
        {
