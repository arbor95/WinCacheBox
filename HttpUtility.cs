...
namespace WinCachebox
{
  ...
  public static class DictionaryExtensions
  {
    ...
    {
      string retString = "---------------------------" + DateTime.Now.Ticks.ToString("x");
    ...
    /// </remarks>
    public static void WriteMultipartFormData(Dictionary<string, string> dictionary, Stream stream, string mimeBoundary)
    {
  ...
  public static class FileInfoExtensions
  {
    ...
    /// </exception>
    public static void WriteMultipartFormData(FileInfo file, Stream stream, string mimeBoundary, string mimeType, string formKey)
    {
      if (file == null)
      {
